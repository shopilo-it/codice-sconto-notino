#!/usr/bin/env python3
"""
Recupero codici sconto Notino da shopilo.it
Sursa: https://shopilo.it/negozi/notino.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/notino.it"
STORE_NAME = "Notino"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Notino da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-notino)"
    }
    try:
